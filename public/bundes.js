...
$(document).ready(function () {
  ...
  $.get('http://localhost:8090/api/nemetcsapat',  // url
  ...
  $.get('http://localhost:8090/api/nemet',  // url
    ...
    $(".csapatok").on("click", ".csapatgomb0 ", function () {
      ...
      $.get('http://localhost:8090/api/bayern',  // url
        function (datam, textStatus, jqXHR) {  // success callback
          console.log(datam)
          for (i = 0; i < datam.length; i++) {
            $('.csapat').append('<div class="macsik' + i + ' csik"></div>')
    ...
    $(".csapatok").on("click", ".csapatgomb1 ", function () {
      ...
      $('.sornevek').append('<div class="kockaj">' + "Sárgalap" + '</div>')
      $('.sornevek').append('<div class="kockaj">' + "Piroslap" + '</div>')
      $.get('http://localhost:8090/api/dortmund',  // url
        function (datam, textStatus, jqXHR) {  // success callback
          console.log(datam)
          for (i = 0; i < datam.length; i++) {
            $('.csapat').append('<div class="macsik' + i + ' csik"></div>')
    ...
    $(".csapatok").on("click", ".csapatgomb2 ", function () {
      ...
      $('.sornevek').append('<div class="kockaj">' + "Sárgalap" + '</div>')
      $('.sornevek').append('<div class="kockaj">' + "Piroslap" + '</div>')
      $.get('http://localhost:8090/api/leipzig',  // url
        function (datam, textStatus, jqXHR) {  // success callback
          console.log(datam)
          for (i = 0; i < datam.length; i++) {
            $('.csapat').append('<div class="macsik' + i + ' csik"></div>')
    ...
    $(".csapatok").on("click", ".csapatgomb3 ", function () {
      ...
      $('.sornevek').append('<div class="kockaj">' + "Sárgalap" + '</div>')
      $('.sornevek').append('<div class="kockaj">' + "Piroslap" + '</div>')
      $.get('http://localhost:8090/api/leverkusen',  // url
        function (datam, textStatus, jqXHR) {  // success callback
          console.log(datam)
          for (i = 0; i < datam.length; i++) {
            $('.csapat').append('<div class="macsik' + i + ' csik"></div>')
    ...
    $(".csapatok").on("click", ".csapatgomb4 ", function () {
      ...
      $('.sornevek').append('<div class="kockaj">' + "Sárgalap" + '</div>')
      $('.sornevek').append('<div class="kockaj">' + "Piroslap" + '</div>')
      $.get('http://localhost:8090/api/freiburg',  // url
        function (datam, textStatus, jqXHR) {  // success callback
          console.log(datam)
          for (i = 0; i < datam.length; i++) {
            $('.csapat').append('<div class="macsik' + i + ' csik"></div>')
    ...
    $(".csapatok").on("click", ".csapatgomb5 ", function () {
      ...
      $('.sornevek').append('<div class="kockaj">' + "Sárgalap" + '</div>')
      $('.sornevek').append('<div class="kockaj">' + "Piroslap" + '</div>')
      $.get('http://localhost:8090/api/unionb',  // url
        function (datam, textStatus, jqXHR) {  // success callback
          console.log(datam)
          for (i = 0; i < datam.length; i++) {
            $('.csapat').append('<div class="macsik' + i + ' csik"></div>')
    ...
    $(".csapatok").on("click", ".csapatgomb10 ", function () {
      ...
      $('.sornevek').append('<div class="kockaj">' + "Sárgalap" + '</div>')
      $('.sornevek').append('<div class="kockaj">' + "Piroslap" + '</div>')
      $.get('http://localhost:8090/api/gladbach',  // url
        function (datam, textStatus, jqXHR) {  // success callback
          console.log(datam)
          for (i = 0; i < datam.length; i++) {
            $('.csapat').append('<div class="macsik' + i + ' csik"></div>')
    ...
    $(".csapatok").on("click", ".csapatgomb15 ", function () {
      ...
      $('.sornevek').append('<div class="kockaj">' + "Sárgalap" + '</div>')
      $('.sornevek').append('<div class="kockaj">' + "Piroslap" + '</div>')
      $.get('http://localhost:8090/api/stuttgart',  // url
        function (datam, textStatus, jqXHR) {  // success callback
          console.log(datam)
          for (i = 0; i < datam.length; i++) {
            $('.csapat').append('<div class="macsik' + i + ' csik"></div>')
    ...
    $(".csapatok").on("click", ".csapatgomb16 ", function () {
      ...
      $('.sornevek').append('<div class="kockaj">' + "Sárgalap" + '</div>')
      $('.sornevek').append('<div class="kockaj">' + "Piroslap" + '</div>')
      $.get('http://localhost:8090/api/bielefeld',  // url
        function (datam, textStatus, jqXHR) {  // success callback
          console.log(datam)
          for (i = 0; i < datam.length; i++) {
            $('.csapat').append('<div class="macsik' + i + ' csik"></div>')
    ...
    $(".csapatok").on("click", ".csapatgomb17 ", function () {
      ...
      $('.sornevek').append('<div class="kockaj">' + "Sárgalap" + '</div>')
      $('.sornevek').append('<div class="kockaj">' + "Piroslap" + '</div>')
      $.get('http://localhost:8090/api/furth',  // url
        function (datam, textStatus, jqXHR) {  // success callback
          console.log(datam)
          for (i = 0; i < datam.length; i++) {
            $('.csapat').append('<div class="macsik' + i + ' csik"></div>')
